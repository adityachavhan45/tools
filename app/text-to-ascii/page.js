...
export const metadata = buildMetadata({
  title:
    "Text to ASCII Converter Online Convert Text to ASCII Code and ASCII to Text Free 2026",
  description:
    "Convert text to ASCII code and ASCII to text instantly with our free online Text to ASCII Converter. Includes formatting, validation and copy options. Perfect for students, developers and programmers. Fast, secure and no signup needed!",
  slug: "/text-to-ascii",
  focusKeyword: "Text to ASCII Converter Online Free",
  keywords:
