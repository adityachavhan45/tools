...
export const metadata = buildMetadata({
  title:
    "Loan Calculator Online Free | Calculate EMI and Interest Instantly",
  description:
    "Calculate loan EMI, total interest, and monthly payments instantly. Simple and accurate loan calculator for personal, home, and car loans.",
